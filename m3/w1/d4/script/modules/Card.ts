import { Abbigliamenti } from "./Abbigliamenti";

export abstract class Card {
    static createCard(cont: HTMLElement, obj:Abbigliamenti): void {
    ...
    static addToCart(container: HTMLElement, obj:Abbigliamenti): void {

        let cont: HTMLElement = document.querySelector('#carello');
        let div: HTMLElement = document.createElement('div');
    ...
    static removeButton(card: HTMLElement, container: HTMLElement, obj:Abbigliamenti): void {
        let puls: HTMLElement = card.querySelector('.rimuovi');
    ...
    static addToLocal(container: HTMLElement, obj:Abbigliamenti): void {
        container.addEventListener('click', () => {
            if (localStorage.getItem('cart')) {
                let cart: Abbigliamenti[] = JSON.parse(localStorage.getItem('cart'));
                let cont: HTMLElement = document.querySelector('#carello');
                cont.innerHTML = '';
    ...
    static removeFromLocal(obj:Abbigliamenti, container: HTMLElement): void {
