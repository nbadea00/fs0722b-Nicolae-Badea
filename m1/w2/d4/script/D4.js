...
for (let i of starWarsCharacters) {
  characters[characters.length] = i.name;
}
...
for (let i of starWarsCharacters) {
  if (i.gender == "female") {
    femaleCharacters[femaleCharacters.length] = { name: i.name, hair_color: i.hair_color, eye_color: i.eye_color };
  }
}
...
for (let i of starWarsCharacters) {
  ...
  switch (i.eye_color) {
    case "blue":
      eyeColor.blue[eyeColor.blue.length] = i;
      break;
    case "yellow":
      eyeColor.yellow[eyeColor.yellow.length] = i;
      break;
    case "brown":
      eyeColor.brown[eyeColor.brown.length] = i;
      break;
    case "red":
      eyeColor.red[eyeColor.red.length] = i;
      break;
    case "blue-gray":
      eyeColor["blue-gray"][eyeColor["blue-gray"].length] = i;
      break;
  }
}
...
let j = 0;
let somm = 0;
/*  si poteva fare anche cosi, forse meglio
for( let i of starWarsCharacters){
  somm += parseInt(i.mass);
}
*/
...
let massa = 0;
//togliere il commento alla riga successiva se si vuole vedere il messaggio relativo alla massa effetiva del equipaggio
//massa = somm;
console.log("7)");
switch (true) {
  case massa < 500:
  ...
  case massa == 500:
    ...
    break;
  case 900 >= massa && massa > 700:
    console.log("Warning: Load is over 700")
    break;
  case 1000 >= massa && massa > 900:
...
console.log("Num personaggi dopo: " + characters.length);
console.log(characters);
